...
function Home() {
  return (
    <div className="md:flex relative p-6 lg:p-0 bg-gray-800 lg:bg-transparent">
      <div className="bg-gray-800 md:flex md:h-screen w-1/3 hidden items-start">
        <div className="md:top-0 md:right-0 mb-6 md:p-6 text-white flex items-center">
          <Logo />
          <Menu />
        </div>
      </div>
      <div className="flex flex-wrap md:h-screen items-center w-full md:w-2/3 mb-6 md:mb-0"></div>
      <div className="flex flex-wrap items-center bg-white shadow-lg md:absolute bio-card position-center rounded container max-w-screen-lg mx-auto">
        <img
          className="w-full md:w-1/2  rounded-t md:rounded-l"
          src={BioImage}
          alt="bio"
        />
        <div className="md:text-left md:w-1/2 p-6 lg:p-12 w-full">
          ...
          <span className="block h-3 w-3 md:inline-block bg-yellow-500 rounded-full mx-auto md:mx-3"></span>
